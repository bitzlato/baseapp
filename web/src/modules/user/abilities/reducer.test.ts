...
describe('Abilities reducer', () => {
  it('should handle ABILITIES_FETCH', () => {
    ...
    expect(abilitiesReducer(initialAbilitiesState, actions.abilitiesFetch())).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle ABILITIES_DATA', () => {
    ...
    expect(
      abilitiesReducer(initialAbilitiesState, actions.abilitiesData(abilitiesResponse)),
  ...
  it('should handle ABILITIES_ERROR', () => {
    ...
    expect(abilitiesReducer(initialAbilitiesState, actions.abilitiesError())).toEqual(
      expectedState,
    );
  });
});
