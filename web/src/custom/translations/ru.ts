...
export const ru: LangType = {
  ...
  'notifications.blockChainMoneyHold':
    'Ваша транзакция {amount} {cryptocurrency} находится на aml-проверке. Ожидайте оповещения о результате проверки',
  ...
  'chat.nomessage': 'Напишите сообщение для начала общения',
  chatwith: 'Чат с',
  notes: 'Заметки',
  noteswith: 'Заметки для',
  online: 'В сети',
  offline: 'Не в сети',

  'trader.stats.success': 'Успешных сделок',
  'trader.stats.canceled': 'Отмененных сделок',
  'trader.stats.defeatin': 'Поражений в спорах',
  'trader.stats.trusted': 'Доверяют пользователю',
  'trader.stats.blacklisted': 'Заблокировало пользователей',
