...
describe('Profile reducer', () => {
  ...
  it('should handle CHANGE_USER_LEVEL', () => {
    ...
    expect(profileReducer(actualState, actions.changeUserLevel({ level: 2 }))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle CHANGE_PASSWORD_FETCH', () => {
    ...
    expect(profileReducer(initialStateProfile, actions.changePasswordFetch(payload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle GENERATE_2FA_QRCODE_FETCH', () => {
    ...
    expect(profileReducer(initialStateProfile, actions.generate2faQRFetch())).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle TOGGLE_2FA_FETCH', () => {
    ...
    expect(profileReducer(initialStateProfile, actions.toggle2faFetch(payload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle CHANGE_USER_FETCH', () => {
    ...
    expect(
      profileReducer(actualState, actions.changeUserDataFetch({ user: userData.user })),
  ...
  it('should handle CHANGE_USER_DATA', () => {
    ...
    expect(profileReducer(actualState, actions.changeUserData({ user: userData.user }))).toEqual(
      expectedState,
    );
  });
});
