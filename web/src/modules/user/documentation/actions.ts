...
export type DocumentationAction = DocTradeUserApiFetch | DocTradeUserApiData | DocTradeUserApiError;

export const docTradeUserApiFetch = (): DocTradeUserApiFetch => ({
  type: DOC_TRADE_USER_API_FETCH,
});

export const docTradeUserApiData = (
  payload: DocTradeUserApiData['payload'],
): DocTradeUserApiData => ({
  type: DOC_TRADE_USER_API_DATA,
  payload,
});

export const docTradeUserApiError = (
  payload: DocTradeUserApiError['payload'],
