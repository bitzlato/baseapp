...
export const selectMarketsAdminUpdate = (
  state: RootState,
): MarketsAdminState['successMarketsUpdate'] => state.admin.markets.successMarketsUpdate;

export const selectEnabledMarketsAdminList = (
  state: RootState,
): MarketsAdminState['enabledMarkets'] => state.admin.markets.enabledMarkets;
