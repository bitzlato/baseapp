...
export const ru: LangType = {
  ...
  'notifications.blockChainMoneySeizure':
    'Вашей транзакции {amount} {cryptocurrency} присвоен статус рискованной. Пожалуйста, обратитесь в службу поддержки',
  'notifications.blockChainMoneyHold':
    'Ваша транзакция {amount} {cryptocurrency} находится на проверке. Ожидайте оповещения о результате проверки',
  ...
  'deposit.success': 'Низкий риск',
  'deposit.aml-seizure': 'Высокий риск',
  'deposit.aml-check': 'На проверке',

  'Your account is restricted!': 'Ваш аккаунт ограничен!',
  'freezed.info':
    'Скорее всего, Вы нарушили какое-то из Правил торговли.{br}{br}Чтобы узнать причину и снять ограничение, пожалуйста, обратитесь в службу поддержки.',
  'Support team': 'Служба поддержки',

  'Security verification': 'Проверка безопасности',
  'verification.kyc': 'Для проведения этой операции, сначала пройдите верификацию личности',
  'verification.info':
    'Верификация обеспечивает безопасность пользователей платформы и повышает гарантии сохранения Ваших активов',
  ...
  'Gift creation': 'Создание чека',
  'gifts.createGift': 'Создать чек',
  'gifts.activeGifts': 'Активные чеки',
  'gifts.activeGifts.notice': 'Здесь Вы можете управлять своими активными чеками',
  'gifts.giftsHistory': 'История',
  'gifts.giftsHistory.notice': 'Здесь вы можете просматривать историю обмена чеками',
  'gifts.notice':
    'Создавайте чеки и делитесь криптовалютой с любым пользователем Bitzlato без комиссии за перевод!',
  'gifts.createNotice':
    'Делитесь криптовалютой с неограниченным количеством людей, создавая единый чек для всех!{br}Чтобы принять чек просто перейдите по ссылке и монеты моментально зачислятся на Ваш баланс!',
  'gifts.createNoticeQuestion': 'Для чего нужен чек и как его создать',
  'gifts.stepCurrency.title': 'Укажите криптовалюту и сумму чека',
  'gifts.stepCurrency.notice': 'Выберите криптовалюту, на которую хотите выписать чек',
  'gifts.amount.notice': 'Введите сумму чека',
  'gifts.stepCount.title': 'Выберите количество пользователей',
  'gifts.stepCount.notice': 'Количество уникальных пользователей, которые смогут обналичить чек',
  'gifts.stepCount.max': 'Максимальное количество пользователей',
  'gifts.stepComment.title': 'Оставьте комментарий ',
  'gifts.stepComment.notice': 'Комментарий сможете увидеть только вы',
  'gifts.selectCryptocurrency': 'Выберите криптовалюту',
  Available: 'Доступно',
  Instruction: 'Инструкция',
  'gifts.instructionNotice': 'Создавать чеки проще простого, можете убедиться самостоятельно',
  'gifts.instruction1': 'Пополните кошелек',
  'gifts.instruction2': 'Выберите валюту и сумму будущего чека',
  'gifts.instruction3': 'Выберите количество использований',
  'gifts.instruction4': 'Создайте чек',
  'gifts.instruction5': 'Отправьте чек друзьям',
  'gifts.willBlockedOnBalance': 'На балансе будет заблокировано',
  'gifts.comment.placeholder': 'Пример: подарок Николаю на день рождения',
  'gifts.createdWithAmount': 'Вы создали чек на сумму {amount}',
  'gifts.createdCopy': 'Скопируйте и отправьте получателю ссылку',
  'gifts.viewWithAmount': 'Ваш чек на сумму {amount}.',
  'gifts.forBot': 'Чек для бота',
  'gifts.forApp': 'Чек для сайта и мобильного приложения',
  Reusable: 'Многоразовый',
  'Single use': 'Одноразовый',
  'gifts.notCashed': 'Чек не обналичен',
  'gifts.cashed': 'Чек обналичили',
  'Gift type': 'Тип чека',
  'gifts.deletedWithAmount': 'Вы удалили {type} чек на сумму {amount}',
  'gifts.availableBalance': 'На аккаунте доступна сумма {amount}',
  'gifts.sent': 'Отправленные',
  'gifts.received': 'Полученные',
  Recipient: 'Получатель',
  Sender: 'Отправитель',
  Copy: 'Скопировать',
  'gifts.mustChooseCryptocurrency': 'Вам необходимо выбрать криптовалюту',
  'gifts.fillField': 'Заполните поле',
  'gifts.greaterThanAvailable': 'На Вашем балансе недостаточно средств',
  'gifts.lessThan1': 'Введите сумму больше 1',
  'gifts.maxCount': 'Укажите количество меньше максимального',
  'gifts.maxCommentLength': 'Вы превысили лимит в {count} символов',
  'gifts.blockedAmount': 'На балансе чеком заблокировано',
  'gifts.timesToWithdrawal': 'Количество использований чека',
  'gifts.emptyMultiGifts': 'Здесь будет список получателей вашего многоразового чека',
  'gifts.emptyActiveGifts': 'Здесь будут отображаться ваши активные чеки',
  'gifts.emptyReceivedGifts': 'Здесь будут отображаться чеки, которые вы обналичили',
  'gifts.emptySentGifts': 'Здесь будут отображаться чеки, которые вы отправили',
  'gifts.allRecipients': 'Все получатели',

  Save: 'Сохранить',

  'merge.title': 'Объединение аккаунтов',
  'merge.web_with_telegram': 'Объединить Web-аккаунт с Telegram-аккаунтом Bitzlato',
  'merge.telegram_with_web': 'Объединить Telegram-аккаунт с Web-аккаунтом Bitzlato',
  'merge.web_get_code': 'Получить код',
  'merge.web_enter_code': 'Применить код',
  'merge.web_title': 'Объединение аккаунта с Telegram',
  'merge.telegram_title': 'Объединение Telegram с аккаунтом',
  'merge.web_start_text':
    'Вы получите специальный код, который необходимо указать в телеграм боте в разделе "Привязать WEB аккаунт" -> "Ввести код", после того как ответите на вопрос безопасности',
  'merge.telegram_start_text':
    '🤖 Введите код который вы получили в телеграм боте в разделе "Привязать WEB аккунт" > "Получить код", после того как ответите на вопрос безопасности.',
  'merge.answer_question': 'Ответить на вопрос',
  'merge.web_security_question':
    '⚠️ Любой агент поддержки, арбитр, служба безопасности не будет просить у вас этот код. Любое третье лицо никогда не должно получить от вас этот код. Передав код для объединения аккаунтов кому-либо или опубликовав его где-либо, вы понимаете, что рискуете потерять свои средства. {br}{br}❓Вы согласны с тем, что код подтверждения нельзя передавать никому, даже настоящим агентам поддержки?',
  'merge.telegram_security_question':
    '⚠️ Любой агент поддержки, арбитр, служба безопасности не будет давать вам код. Любое третье лицо, которое просит вас ввести код, полученный от него - мошенник. Введя код для объединения аккаунтов который вы получили от кого-то или взяли где-либо кроме bitzlato.bz/profile в разделе "Объединение аккаунтов" вы потеряете свои средства.{br}{br}❓Вы согласны с тем, что код подтверждения нельзя брать ни у кого, даже у настоящих агентов поддержки, а только лично в своем аккаунте bitzlato.bz/profile в разделе "Объединение аккаунтов"?',
  'merge.web_test_failed': 'В таком случае мы не можем показать вам код для объединения!',
  'merge.telegram_test_failed':
    'Неправильно! Никому нельзя передавать данный код, даже службе поддержки и любому, кто его у вас просит, чтобы вам не сказали и в чем бы не уверяли. Запомните это правило и попробуйте еще раз',
  'merge.enter_token': 'Чтобы объединить аккаунты, введите код, полученный в телеграм боте:',
  'merge.token_send': 'Объединить',
  'merge.merged':
    'Вы уже привязали вашу учетную запись к telegram-аккаунту (@{username}). Теперь вы можете совершать сделки, как в веб-версии на bitzlato.com, так и в боте!',

  'Please wait for new merge token':
    'Токен уже сгенерирован! Пожалуйста, подождите перед созданием нового токена',
  wrongMergeCode: 'Неверный код',
  ...
  'Attention!': 'Внимание!',
  login_for_get_check:
    'Вы перешли по чек-ссылке! Для получения монет Вам необходимо войти в систему!',
  showWithdrawVoucher:
    'Вы получили ваучер на бесплатный вывод!\nИспользуйте его при отправке монет из сервиса!',
  WithdrawVoucherNotFound:
    '😔 Упс!\n\nДанный ваучер на бесплатный вывод успел обналичить кто-то другой!',
  'Already cashed by the user':
    'Вы уже обналичили данный чек.\n\nВы можете использовать этот чек только один раз.',
  'Already cashed': 'Данный чек уже обналичили. Все детали можете узнать у создателя чека.',
