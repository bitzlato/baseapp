...
describe('withdrawLimitList reducer', () => {
  ...
  it('should handle WITHDRAW_LIMIT_FETCH', () => {
    ...
    expect(withdrawLimitReducer(initialWithdrawLimitState, actions.withdrawLimitFetch())).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle WITHDRAW_LIMIT_DATA', () => {
    ...
    expect(
      withdrawLimitReducer(initialWithdrawLimitState, actions.withdrawLimitData(withdrawLimit)),
