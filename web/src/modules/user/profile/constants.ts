...
export const PROFILE_TOGGLE_2FA_SUCCESS = 'profile/TOGGLE_2FA_SUCCESS';
...
export const PROFILE_USER_REFETCH = 'profile/PROFILE_USER_REFETCH';
...
export const PROFILE_TOGGLE_FREEZED = 'profile/TOGGLE_FREEZED';
