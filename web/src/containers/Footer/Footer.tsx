                ...
                <div className={s.row}>
                    ...
                    <div className={s.col}>
                        ...
                        <div className={s.links}>
                            ...
                            <a className={s.link} href={getBitzlatoLink(languageCode, 'terms-of-service-bitzlato')}>
                                Terms of Service Bitzlato
                            </a>
                            <a className={s.link} href={getBitzlatoLink(languageCode, 'exchange-terms-and-conditions')}>
