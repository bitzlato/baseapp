...
export const selectMarketSelectorState = (
  state: RootState,
): ColorThemeState['marketSelectorActive'] => state.public.colorTheme.marketSelectorActive;
...
export const selectApplyWindowEnvsTriggerState = (
  state: RootState,
): ColorThemeState['applyWindowEnvsTrigger'] => state.public.colorTheme.applyWindowEnvsTrigger;
