...
export const rangerDirectMessage = (
  payload: RangerDirectMessage['payload'],
): RangerDirectMessage => ({
...
export const subscriptionsUpdate = (
  payload: SubscriptionsUpdate['payload'],
): SubscriptionsUpdate => ({
  type: RANGER_SUBSCRIPTIONS_DATA,
  payload,
});

export const rangerSubscribeMarket = (market: Market): RangerDirectMessage =>
  rangerSubscribe(marketStreams(market));
export const rangerUnsubscribeMarket = (market: Market): RangerDirectMessage =>
  rangerUnsubscribe(marketStreams(market));
export const rangerSubscribeKlineMarket = (
  marketId: string,
  periodString: string,
): RangerDirectMessage => rangerSubscribe(marketKlineStreams(marketId, periodString));
export const rangerUnsubscribeKlineMarket = (
  marketId: string,
  periodString: string,
): RangerDirectMessage => rangerUnsubscribe(marketKlineStreams(marketId, periodString));
