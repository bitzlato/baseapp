    ...
    return (
      <div className="pg-header__toolbar">
        <div className="pg-header__toolbar-item">
          <p
            className={cn(
              'pg-header__toolbar-item-value pg-header__toolbar-item-value-positive',
              s.itemValue,
            )}
          >
            {currentMarket &&
              Decimal.format(
                Number(this.getTickerValue('low')),
        ...
        <div className="pg-header__toolbar-item">
          <p
            className={cn(
              'pg-header__toolbar-item-value pg-header__toolbar-item-value-negative',
              s.itemValue,
            )}
          >
            {currentMarket &&
              Decimal.format(
                Number(this.getTickerValue('last')),
                currentMarket.price_precision,
                ',',
              )}{' '}
            {bidUnit}
        ...
        <div className="pg-header__toolbar-item">
          ...
          >
            {currentMarket &&
              Decimal.format(
                Number(this.getTickerValue('high')),
                currentMarket.price_precision,
                ',',
              )}{' '}
            {bidUnit}
        ...
        <div className="pg-header__toolbar-item">
          ...
          >
            {currentMarket &&
              Decimal.format(
                Number(this.getTickerValue('volume')),
                currentMarket.price_precision,
                ',',
              )}{' '}
            {bidUnit}
        ...
        <div className="pg-header__toolbar-item">
          <p
            className={`pg-header__toolbar-item-value pg-header__toolbar-item-value-${cls} ${s.itemValue}`}
          >
            {currentMarket &&
...
const HeaderToolbar = injectIntl(
  withRouter(connect(mapStateToProps, {})(HeaderToolbarContainer) as any) as any,
);
