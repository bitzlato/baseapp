...
const BeneficiariesComponent: React.FC<Props> = (props: Props) => {
      ...
      return (
        <div className="pg-beneficiaries__dropdown__tip tip">
          <div className="tip__content">
            <div className="tip__content__block">
              <span className="tip__content__block__label">
                {formatMessage({ id: 'page.body.wallets.beneficiaries.tipAddress' })}
              </span>
            ...
            {currentWithdrawalBeneficiary.description &&
              renderDropdownTipCryptoNote(currentWithdrawalBeneficiary.description)}
          </div>
        </div>
      );
    }
  ...
  const renderDropdownTipFiatDescription = (description: string) => {
    return (
      <div className="tip__content__block">
        <span className="tip__content__block__label">
          {formatMessage({ id: 'page.body.wallets.beneficiaries.dropdown.fiat.description' })}
        </span>
        ...
        return (
          <div className="pg-beneficiaries__dropdown__tip tip fiat-tip">
            <div className="tip__content">
              ...
              {currentWithdrawalBeneficiary.description &&
                renderDropdownTipFiatDescription(currentWithdrawalBeneficiary.description)}
              <div className="tip__content__block">
                <span className="tip__content__block__label">
  ...
  const renderAddressDropdown = React.useCallback(
    (
      ...
      const isPending =
        ...
        currentWithdrawalBeneficiary.state.toLowerCase() === 'pending';
  ...
  const renderDropdownBody = React.useCallback(
    (beneficiariesList: Beneficiary[], type: 'fiat' | 'coin') => {
      ...
      return (
        <div className={dropdownBodyClassName}>
          {beneficiariesList &&
            beneficiariesList.map((item, index) => renderDropdownItem(item, index, type))}
          <div
  ...
  const filtredBeneficiaries = React.useMemo(
    () => handleFilterByState(beneficiaries, ['active', 'pending']),
    [beneficiaries],
  );
  ...
  return (
    <div className="pg-beneficiaries">
      ...
      {filtredBeneficiaries.length
        ? renderAddressDropdown(filtredBeneficiaries, currentWithdrawalBeneficiary, type)
        : renderAddAddress}
