...
describe('Documentation reducer', () => {
  ...
  it('should handle DOC_TRADE_USER_API_FETCH', () => {
    ...
    expect(documentationReducer(initialDocumentationState, actions.docTradeUserApiFetch())).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle DOC_TRADE_USER_API_DATA', () => {
    ...
    expect(
      documentationReducer(initialDocumentationState, actions.docTradeUserApiData(fakeResponse)),
  ...
  it('should handle DOC_TRADE_USER_API_ERROR', () => {
    ...
    expect(
      documentationReducer(initialDocumentationState, actions.docTradeUserApiError(fakeError)),
    ).toEqual(expectedState);
  });
});
