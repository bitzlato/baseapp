...
export const ru: LangType = {
  ...
  'merge.telegram_security_question':
    '⚠️ Любой агент поддержки, арбитр, служба безопасности не будет давать вам код. Любое третье лицо, которое просит вас ввести код, полученный от него - мошенник. Введя код для объединения аккаунтов который вы получили от кого-то или взяли где-либо кроме bitzlato.com/ru/p2p в разделе "Личный кабинет" - "Telegram" вы потеряете свои средства.{br}{br}❓Вы согласны с тем, что код подтверждения нельзя брать ни у кого, даже у настоящих агентов поддержки, а только лично в своем аккаунте bitzlato.com/ru/p2p в разделе "Личный кабинет" - "Telegram"?',
  ...
  'merge.error': '{error}. Пожалуйста, попробуйте ещё раз.',
  'merge.enter_token': 'Чтобы объединить аккаунты, введите код, полученный в телеграм боте:',
  'merge.token_send': 'Объединить',
  'merge.merged':
    'Вы уже привязали вашу учетную запись к telegram-аккаунту. Теперь вы можете совершать сделки, как в веб-версии на bitzlato.com, так и в боте!',
};
