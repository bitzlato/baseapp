...
describe('Phone reducer', () => {
  ...
  it('should handle SEND_CODE_FETCH', () => {
    ...
    expect(phoneReducer(initialPhoneState, actions.sendCode(sendPhonePayload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle RESEND_CODE_FETCH', () => {
    ...
    expect(phoneReducer(initialPhoneState, actions.resendCode(sendPhonePayload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle VERIFY_PHONE_FETCH', () => {
    ...
    expect(phoneReducer(initialPhoneState, actions.verifyPhone(verifyCodeFetchPayload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle VERIFY_PHONE_DATA', () => {
    ...
    expect(phoneReducer(initialPhoneState, actions.verifyPhoneData(verifyCodeDataPayload))).toEqual(
      expectedState,
    );
  });
