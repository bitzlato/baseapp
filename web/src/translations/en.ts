...
export const en = {
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
  ...
  'Gift creation': 'Creating a check',
  'gifts.createGift': 'Create a check',
  'gifts.activeGifts': 'Active checks',
  'gifts.activeGifts.notice': 'Here You can manage your active checks',
  'gifts.giftsHistory': 'History',
  'gifts.giftsHistory.notice': 'Here You can view the history of check exchange',
  'gifts.notice':
    'Create checks and share cryptocurrency with any Bitzlato user without transfer fees!',
  'gifts.createNotice':
    'Share cryptocurrency with an unlimited number of people by creating a single check for everyone!{br}To accept the check just click the link and coins will be instantly transferred to Your balance!',
  'gifts.createNoticeQuestion': 'What the check is for and how to create it',
  'gifts.stepCurrency.title': 'Specify the cryptocurrency and amount of the check',
  'gifts.stepCurrency.notice': 'Select the cryptocurrency for which you want to create a check',
  'gifts.amount.notice': 'Enter the amount of the check',
  'gifts.stepCount.title': 'Select the number of users',
  'gifts.stepCount.notice': 'The number of unique users who will be able to cash the check',
  'gifts.stepCount.max': 'Maximum number of users',
  'gifts.stepComment.title': 'Add a comment ',
  'gifts.stepComment.notice': 'Only you can see the commentary',
  'gifts.selectCryptocurrency': 'Choose cryptocurrency',
  Available: 'Available',
  Instruction: 'Instructions',
  'gifts.instructionNotice': "It's easy to create checks, you can see for yourself",
  'gifts.instruction1': 'Refill your wallet',
  'gifts.instruction2': 'Select the currency and amount of the future check',
  'gifts.instruction3': 'Choose the number of uses',
  'gifts.instruction4': 'Create a check',
  'gifts.instruction5': 'Send a check to your friends',
  'gifts.willBlockedOnBalance': 'On the balance will be blocked',
  'gifts.comment.placeholder': "Example: gift for Nikolai's birthday",
  'gifts.createdWithAmount': 'You created a check in the amount of {amount}',
  'gifts.createdCopy': 'Copy the link and send it to the user',
  'gifts.viewWithAmount': 'Your check for the amount of {amount}.',
  'gifts.forBot': 'Check for bot',
  'gifts.forApp': 'Check for the website and mobile app',
  Reusable: 'Multiuse',
  'Single use': 'Disposable',
  'gifts.notCashed': 'Check is not cashed',
  'gifts.cashed': 'Check was cashed by',
  'Gift type': 'Cheque type',
  'gifts.deletedWithAmount': 'You deleted a {type} check for the amount of {amount}',
  'gifts.availableBalance': 'The account has an available amount of {amount}',
  'gifts.sent': 'Sent',
  'gifts.received': 'Retrieved',
  Recipient: 'Recipient',
  Sender: 'Sender',
  Copy: 'Copy',
  'gifts.mustChooseCryptocurrency': 'You must choose a cryptocurrency',
  'gifts.fillField': 'Fill in the box',
  'gifts.greaterThanAvailable': 'There are not enough funds on your balance',
  'gifts.lessThan1': 'Enter an amount greater than 1',
  'gifts.maxCount': 'Specify the number less than the maximum',
  'gifts.maxCommentLength': 'You have exceeded the {count} character limit',
  'gifts.blockedAmount': 'The balance is blocked by check',
  'gifts.timesToWithdrawal': 'Number of check usage',
  'gifts.emptyMultiGifts': 'Here will be a list of recipients of your multi-check',
  'gifts.emptyActiveGifts': 'Your active checks will be displayed here',
  'gifts.emptyReceivedGifts': 'Checks that you have cashed will be displayed here',
  ...
  'merge.merged':
    'You have already attached your profile to telegram-account (@{username}). Now you can trade both on web bitzlato.com and in telegram-bot!',

  'Please wait for new merge token':
    'Token already generated! Please wait before creating a new token',
  wrongMergeCode: 'Incorrect code',
