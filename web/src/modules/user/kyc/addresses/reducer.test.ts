...
describe('Addresses reducer', () => {
  ...
  it('should handle SEND_ADDRESSES_FETCH', () => {
    ...
    expect(addressesReducer(initialAddressesState, actions.sendAddresses(payloadFormData))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle SEND_ADDRESSES_DATA', () => {
    ...
    expect(
      addressesReducer(initialAddressesState, actions.sendAddressesData(confirmAddressesResponse)),
