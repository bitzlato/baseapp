...
describe('blacklistCountryReducer', () => {
  ...
  it('should handle SEND_BLOCKLIST_ACCESS_TOKEN_FETCH', () => {
    ...
    expect(
      blocklistAccessReducer(
        initialBlocklistAccessState,
        actions.sendAccessToken({ whitelink_token: '' }),
      ),
  ...
  it('should handle SEND_BLOCKLIST_ACCESS_TOKEN_DATA', () => {
    ...
    expect(
      blocklistAccessReducer(initialBlocklistAccessState, actions.sendAccessTokenData()),
    ).toEqual(expectedState);
  });
  ...
  it('should handle SEND_BLOCKLIST_ACCESS_TOKEN_ERROR', () => {
    ...
    expect(
      blocklistAccessReducer(initialBlocklistAccessState, actions.sendAccessTokenError(error)),
    ).toEqual(expectedState);
  });
  ...
  it('should handle SET_BLOCKLIST_STATUS', () => {
    ...
    expect(
      blocklistAccessReducer(initialBlocklistAccessState, actions.setBlocklistStatus(payload)),
    ).toEqual(expectedState);
  });
});
