...
export const en = {
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
  ...
  'chat.nomessage': 'Please Send message for start conversation',
  notes: 'Notes',
  noteswith: 'Notes for',
  online: 'Online',
  offline: 'Offline',

  'trader.stats.success': 'Success deals',
  'trader.stats.canceled': 'Canceled deals',
  'trader.stats.defeatin': 'Defeat in dispute',
  'trader.stats.trusted': 'Trusted',
  'trader.stats.blacklisted': 'Blacklisted',
