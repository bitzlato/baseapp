...
export const Table: React.FC<TableProps> = (props: TableProps) => {
  ...
  const [selectedRowKey, setSelectedRowKey] = React.useState<TableState['selectedRowKey']>(
    props.selectedKey,
  );
  ...
  const renderBackground = React.useCallback(
    (rows: CellData[][]) => {
      ...
      return (
        <div className={className}>{rowBackground && dataToBeMapped.map(renderBackgroundRow)}</div>
      );
    },
