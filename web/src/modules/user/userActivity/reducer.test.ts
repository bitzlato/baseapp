...
describe('UserActivity reducer', () => {
  ...
  it('should handle USER_ACTIVITY_FETCH', () => {
    ...
    expect(userActivityReducer(initialUserActivityState, actions.getUserActivity(payload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle USER_ACTIVITY_DATA', () => {
    ...
    expect(
      userActivityReducer(initialUserActivityState, actions.userActivityData(payload)),
