...
describe('Markets reducer', () => {
  ...
  it('should handle MARKETS_DATA', () => {
    ...
    expect(marketsReducer(initialMarketsState, actions.marketsData(fakeMarkets))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle MARKETS_TICKERS_FETCH', () => {
    ...
    expect(marketsReducer(initialMarketsState, actions.marketsTickersFetch())).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle MARKETS_TICKERS_DATA', () => {
    ...
    expect(
      marketsReducer(initialMarketsState, actions.marketsTickersData(marketsTickersList)),
    ).toEqual(expectedState);
  });
  ...
  it('should handle MARKETS_TICKERS_ERROR', () => {
    ...
    expect(marketsReducer(initialMarketsState, actions.marketsTickersError(error))).toEqual(
      expectedState,
    );
  });
});
