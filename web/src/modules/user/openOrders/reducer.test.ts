...
describe('Open Orders reducer', () => {
  ...
  it('should handle USER_OPEN_ORDERS_FETCH', () => {
    ...
    expect(openOrdersReducer(initialOpenOrdersState, actions.userOpenOrdersFetch(payload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle USER_OPEN_ORDERS_ERROR', () => {
    ...
    expect(openOrdersReducer(initialState, actions.userOpenOrdersError(error))).toEqual(
      expectedState,
    );
  });
  ...
  describe('USER_OPEN_ORDERS_APPEND', () => {
    ...
    it('inserts order', () => {
      ...
      expect(
        openOrdersReducer(initialOpenOrdersState, actions.userOpenOrdersAppend(newOrder)),
  ...
  describe('USER_OPEN_ORDERS_UPDATE', () => {
    ...
    it('insert new order by ID', () => {
      ...
      expect(
        openOrdersReducer(initialOpenOrdersState, actions.userOpenOrdersUpdate(newOrderEvent)),
      ).toEqual(expectedState);
    });
  ...
  it('should handle OPEN_ORDERS_CANCEL_FETCH', () => {
    ...
    expect(openOrdersReducer(initialState, actions.openOrdersCancelFetch(payload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle OPEN_ORDERS_CANCEL_DATA', () => {
    ...
    expect(openOrdersReducer(initialState, actions.openOrdersCancelData(payload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle OPEN_ORDERS_CANCEL_ERROR', () => {
    ...
    expect(openOrdersReducer(initialState, actions.openOrdersCancelError(error))).toEqual(
      expectedState,
    );
  });
});
