...
class AddressComponent extends React.Component<Props, State> {
  ...
  public render() {
    ...
    const { address, addressFocused, city, cityFocused, postcode, postcodeFocused, fileScan } =
      this.state;
  ...
  private uploadFileSizeGuide = () => {
    ...
    return this.translate(
      'page.body.kyc.address.uploadFile.sizeMax',
      barongUploadSizeMaxRange.toString(),
    );
  };
  ...
  private handleCheckButtonDisabled = () => {
    const { address, city, country, fileScan, postcode, fileSizeErrorMessage } = this.state;
  ...
  private translate = (key: string, value?: string, min?: string) =>
