...
describe('configReducer', () => {
  ...
  it('should handle CONFIG_UPDATE', () => {
    ...
    expect(configUpdateReducer(initialConfigUpdateState, actions.configUpdate(payload))).toEqual(
      expectedState,
    );
  });
  ...
  it('should handle CONFIG_UPDATE_DATA', () => {
    ...
    const payload = fakeConfig;
    expect(
      configUpdateReducer(initialConfigUpdateState, actions.configUpdateData(payload)),
  ...
  it('should handle CONFIG_UPDATE_ERROR', () => {
    ...
    expect(configUpdateReducer(initialConfigUpdateState, actions.configUpdateError(error))).toEqual(
      expectedState,
    );
  });
});
